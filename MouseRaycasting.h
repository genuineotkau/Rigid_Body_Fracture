...
public:
	...
	glm::vec3 GenerateMouseRay(double x, double y, int scrWidth, int scrHeight, const glm::mat4& proj, const glm::mat4& view) {
		#ifdef DEBUG
		...
		glm::vec3 dir = glm::normalize(glm::vec3(worldPos) - camera->Position);
		return dir;
	}
