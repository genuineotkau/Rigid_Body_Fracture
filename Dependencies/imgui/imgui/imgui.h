...
namespace ImGui
{
    ...
    IMGUI_API bool          IsKeyDown(int user_key_index);                                      // is key being held. == io.KeysDown[user_key_index]. note that imgui doesn't know the semantic of each entry of io.KeysDown[]. Use your own m_indices/enums according to how your backend/engine stored them into io.KeysDown[]!
