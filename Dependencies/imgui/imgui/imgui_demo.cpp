...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Plots Widgets"))
    {
        ...
        // FIXME: This is rather awkward because current plot API only pass in m_indices. We probably want an API passing floats and user provide sample rate/count.
        struct Funcs
        {
...
struct ExampleAppConsole
{
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        // A typical application wanting coarse clipping and filtering may want to pre-compute an array of m_indices that passed the filtering test, recomputing this array when user changes the filter,
